...
void main() {
  ...
  group('AuthLocalRepository', () {
    ...
    test('setToken handles errors gracefully', () async {
      const token = 'test-token';
      when(mockTokenBox.put('token', token)).thenThrow(Exception('Failed to store token'));
    ...
    test('setUser handles errors gracefully', () async {
      final user = userMock;
      when(mockUserBox.put('user', user)).thenThrow(Exception('Failed to store user'));
    ...
    test('deleteToken handles errors gracefully', () async {
      when(mockTokenBox.delete('token')).thenThrow(Exception('Failed to delete token'));
    ...
    test('deleteUser handles errors gracefully', () async {
      when(mockUserBox.delete('user')).thenThrow(Exception('Failed to delete user'));
