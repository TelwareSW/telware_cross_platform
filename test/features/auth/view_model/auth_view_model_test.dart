...
void main() {
  ...
  group('AuthViewModel', () {
    ...
    test('init initializes the state correctly', () async {
      ...
      expect(container.read(authViewModelProvider).type, AuthStateType.authorized);
    ...
    test('init handles missing token', () async {
      ...
      expect(container.read(authViewModelProvider).type, AuthStateType.unauthorized);
      verify(mockAuthLocalRepository.getToken()).called(1);
    });
    ...
    test('isAuthenticated returns true when authenticated', () {
      ...
      final result = authViewModel.isAuthenticated();
    ...
    test('logOut sets state to unauthorized', () async {
      container = ProviderContainer(
        overrides: [
          authLocalRepositoryProvider.overrideWithValue(mockAuthLocalRepository),
          authRemoteRepositoryProvider.overrideWithValue(mockAuthRemoteRepository),
